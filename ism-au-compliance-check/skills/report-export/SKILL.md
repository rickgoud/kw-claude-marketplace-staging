...
3. Embed both layers verbatim in the txt/PDF narrative and as two `# ...` comment header lines atop the CSV:
   ...
   - **Scope caveat for this agent:** This ISM (Australia) Compliance Check report is a best-effort assessment based only on the Kiteworks content and metadata scanned. It is not a certification, audit opinion, professional advice, or legal determination of compliance; unscanned systems, controls, processes, and evidence were not evaluated.
