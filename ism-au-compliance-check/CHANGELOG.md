...
- changed: skills/ism-au-compliance-check/SKILL.md
...
Checks a Kiteworks folder for the Australian ISM-relevant signals a file-sharing platform can actually see — sensitive content and external sharing — and saves a report, clearly flagging what falls outside its view.

- added: README.md
- added: agents/ism-au-compliance-check.md
...
- added: skills/ism-au-compliance-check/SKILL.md
