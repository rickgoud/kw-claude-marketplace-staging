...
3. Embed both layers verbatim in the txt/PDF narrative and as two `# ...` comment header lines atop the CSV:
   ...
   - **Scope caveat for this agent:** Productivity-grade, best-effort output. Legal hold and tenant retention policy were NOT evaluated. These are review candidates only — NOT a deletion or disposition basis.
