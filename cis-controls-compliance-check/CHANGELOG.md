...
Checks a Kiteworks folder for the CIS Controls-relevant signals a file-sharing platform can actually see — sensitive content and external sharing — and saves a report, clearly flagging what falls outside its view.

- added: README.md
- added: agents/cis-controls-compliance-check.md
- added: skills/cis-controls-compliance-check/SKILL.md
