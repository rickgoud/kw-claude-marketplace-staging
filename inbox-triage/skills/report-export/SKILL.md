...
3. Embed both layers verbatim in the txt/PDF narrative and as two `# ...` comment header lines atop the CSV:
   ...
   - **Scope caveat for this agent:** This Inbox Triage report is a best-effort analysis based only on the Kiteworks content and metadata scanned. It may be incomplete or inaccurate, and does not evaluate unscanned systems, legal obligations, or tenant retention policy; review results before acting.
